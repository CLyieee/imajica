    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item open active">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="void-logs.html" class="menu-link">
...
<!-- / Navbar -->
    ...
    <div class="card mb-4">
      <div class="card-body">
          <div class="row">
              <div class="col-md-4">
                  <div class="card card-custom card-top-sales">
              ...
              <div class="col-md-4">
                  <div class="card card-custom card-monthly-sales">
                      <div class="card-body d-flex justify-content-between align-items-center">
                          <div>
              ...
              <div class="col-md-4">
                  <div class="card card-custom card-top-employee">
                      <div class="card-body d-flex justify-content-between align-items-center">
                          <div>
